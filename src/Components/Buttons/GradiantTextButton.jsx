...
const GradiantTextButton = ({ text, icon, isFull = false }) => {

  console.log(isFull, "here")
  return (

    <button className={`${isFull ? 'w-full' : ' bg-linear-to-r from-[rgba(79,57,246,1)] to-[rgba(149,20,250,1)]'} btn rounded-full px-0.5 py-0.5`}>
