...
const InstructCard = ({ step, icon, title, content }) => {
  return (
    <>
      <div className="card w-96 h-96 bg-base-100 card-xl shadow-sm">
        ...
        <div className="text-center p-6">
          ...
          <div className='mx-auto relative mb-4'>
            <div className='absolute top-6 left-37'>{icon}</div>
            <div className='w-10 mx-auto rounded-full bg-linear-to-r from-[rgba(79,57,246,1)] to-[rgba(149,20,250,1)] opacity-[0.1]  p-11'></div>
          </div>
